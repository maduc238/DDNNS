...
if __name__ == '__main__':
    ...
    g.add_node("A", mem_size=2048, idle_mem=100, mem_rate=1, training_rate=50)
    g.add_node("B", mem_size=4096, idle_mem=100, mem_rate=1, training_rate=100)
    g.add_node("D", mem_size=4096, idle_mem=100, mem_rate=1, training_rate=100)
    g.add_node("C", mem_size=2048, idle_mem=100, mem_rate=0.5, training_rate=100)
