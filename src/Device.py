class Device:
    def __init__(self, name: str, mem_size: float, idle_mem: float, mem_rate: float, training_rate: float):
        """
        :param name: Name of device
        :param mem_size: memory size with MB
        :param idle_mem: idle memory size with MB
